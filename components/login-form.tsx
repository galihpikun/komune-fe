            ...
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  <a
                    href="#"
                    className="ml-auto text-sm text-gray-400 underline-offset-2 hover:text-white hover:underline">
              ...
              <FieldSeparator className="text-gray-400 *:data-[slot=field-separator-content]:bg-[#1E293B]">
                Or continue with
              </FieldSeparator>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button
                  variant="outline"
                  type="button"
                  className="border-gray-700 bg-[#0F172A] text-gray-300 hover:bg-[#1E293B] hover:text-white">
